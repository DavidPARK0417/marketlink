/**
 * @file components/admin/RetailInquiryTableSkeleton.tsx
 * @description 소매 문의 테이블 로딩 스켈레톤
 *
 * 소매 문의 목록을 로딩하는 동안 표시되는 스켈레톤 UI입니다.
 * 데스크톱에서는 테이블 형태, 모바일에서는 카드 형태로 표시됩니다.
 */

export default function RetailInquiryTableSkeleton() {
  return (
