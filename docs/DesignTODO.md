...
- [x] 관리자 대시보드 스타일 업데이트
- [x] 관리자 CS 페이지 스타일 업데이트
- [x] 기타 관리자 페이지 스타일 업데이트
- [ ] 빌드 에러 확인
...
- [x] 사용하지 않는 Blue 계열 클래스 제거
- [x] 주석 처리된 코드 제거 (발견되지 않음)
- [x] 사용하지 않는 컴포넌트 제거 (빌드 테스트로 확인 필요)
- [x] 사용하지 않는 import 제거 (빌드 테스트로 확인 필요)
...
- [x] 디자인 변경 이력 문서화 (`docs/DESIGN_MIGRATION_HISTORY.md`)
- [x] 변경된 색상/폰트 시스템 문서화 (`docs/DESIGN_SYSTEM_REFERENCE.md`)
- [ ] README 업데이트 (필요시)
